...
public class FactoryBeanStaticMethodDemo {
	
	public static void main(String[] args) throws Exception {
		ClassPathXmlApplicationContext ctx=new ClassPathXmlApplicationContext("app-context_factorybean_staticmethod.xml");  
